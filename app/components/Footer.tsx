        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full">
          ...
          <div className="flex flex-col items-start justify-between h-full">
            ...
            <div className="mb-4 w-full">
              ...
              <div className="flex justify-between items-center w-full px-3 py-3 rounded-xl bg-white/70 dark:bg-gray-800/70 backdrop-blur-md shadow-inner border border-gray-200 dark:border-gray-700">
                {/* Facebook Icon */}
                <a
                  href="https://www.facebook.com/himalayankitchenmarin"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white rounded-full p-2 shadow hover:shadow-lg transition-all border-2 border-blue-500/20 hover:border-blue-500"
                  aria-label="Facebook"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white rounded-full p-2 shadow hover:shadow-lg transition-all border-2 border-pink-500/20 hover:border-pink-500"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white rounded-full p-2 shadow hover:shadow-lg transition-all border-2 border-red-500/20 hover:border-red-500"
                  aria-label="Yelp"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white rounded-full p-2 shadow hover:shadow-lg transition-all border-2 border-green-500/20 hover:border-green-500"
                  aria-label="Google"
                >
                ...
                <a
                  ...
                  className="bg-white rounded-full p-2 shadow hover:shadow-lg transition-all border-2 border-yellow-500/20 hover:border-yellow-500"
                  aria-label="Email"
                >
          ...
          <div className="flex flex-col gap-8">
            <div className="rounded-2xl bg-linear-to-br from-orange-50 via-white to-red-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 shadow-lg border border-orange-200/40 dark:border-red-500/30 p-8">
              <h3 className="text-xl font-bold mb-6 text-orange-700 dark:text-orange-300 flex items-center gap-2">
                <svg className="w-6 h-6 text-orange-400 dark:text-orange-300" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>
                Contact Info
              </h3>
            ...
            <div className="rounded-2xl bg-linear-to-br from-yellow-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 shadow-lg border border-yellow-200/40 dark:border-orange-500/30 p-8">
              <h3 className="text-xl font-bold mb-6 text-yellow-700 dark:text-yellow-300 flex items-center gap-2">
                <svg className="w-6 h-6 text-yellow-400 dark:text-yellow-300" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.477 2 2 6.477 2 12c0 5.523 4.477 10 10 10s10-4.477 10-10c0-5.523-4.477-10-10-10zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8zm-1-13h2v6h-2zm0 8h2v2h-2z"/></svg>
                Opening Hours
              </h3>
              <ul className="space-y-4">
                <li className="flex justify-between items-center text-gray-700 dark:text-gray-200">
                  <span className="font-semibold">Lunch:</span>
                  <span className="bg-yellow-100 dark:bg-yellow-900/30 px-3 py-1 rounded-lg text-yellow-700 dark:text-yellow-300 font-bold">11:30 AM - 02:30 PM</span>
                </li>
                <li className="flex justify-between items-center text-gray-700 dark:text-gray-200">
                  <span className="font-semibold">Dinner:</span>
                  <span className="bg-orange-100 dark:bg-orange-900/30 px-3 py-1 rounded-lg text-orange-700 dark:text-orange-300 font-bold">04:30 PM - 09:00 PM</span>
                </li>
                <li className="flex justify-between items-center text-gray-700 dark:text-gray-200">
