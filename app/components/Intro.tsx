        ...
        >
          ...
          <div
            className={`overflow-hidden transition-all duration-500 ease-in-out w-full ${
              isExpanded ? 'max-h-[900px] sm:max-h-[700px] lg:max-h-[400px] opacity-100 mt-4 sm:mt-6' : 'max-h-0 opacity-0 mt-0'
            }`}
          >
            {/* Responsive Layout: 
                Mobile: Images side by side on top, text below
                Desktop: Three columns (Boy | Text | Girl) */}
            <div className="flex flex-col lg:flex-row items-center lg:items-center justify-between gap-3 sm:gap-4 lg:gap-6 px-2 w-full">
