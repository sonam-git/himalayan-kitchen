...
export default function Intro() {
  ...
  return (
    <section
      ...
      className="relative flex flex-col items-center justify-center max-w-7xl mx-auto my-4 px-0 py-0"
    >
      ...
      <div className="w-full flex flex-col items-center justify-center px-4 mb-4">
        <div className="w-full  px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 shadow-lg ">
          <h2
            id="intro-heading"
            className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-orange-600 dark:text-yellow-300 font-serif drop-shadow-xl tracking-tight text-center"
          >
            ...
            <div className="w-full mt-2 sm:mt-4 lg:mt-6">
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-center justify-between gap-2 sm:gap-3 lg:gap-6 px-2 w-full">
                ...
                <div className="w-full flex lg:hidden items-center justify-center gap-2 sm:gap-3 order-1">
                  ...
                  <div
                    className={`w-1/2 flex flex-col items-center justify-center transition-all duration-1000 ease-out ${
                      isVisible
                ...
                <div
                  className={`hidden lg:flex w-full lg:w-1/3 flex-col items-center justify-center order-1 transition-all duration-1000 ease-out ${
                    isVisible
                      ? "translate-x-0 opacity-100"
                      : "-translate-x-full opacity-0"
                  }`}
                ...
                <div className="w-full lg:w-2/3 flex flex-col items-center justify-center space-y-1.5 sm:space-y-2 lg:space-y-4 order-2 lg:order-2 py-1 sm:py-2">
                  ...
                  <div className="bg-gradient-to-br from-gray-100 to-gray-200 dark:from-orange-900/40 dark:to-gray-900/40 backdrop-blur-sm rounded-lg sm:rounded-xl p-1.5 sm:p-2 lg:p-4 shadow-lg border border-yellow-300/50 sm:border-2 dark:border-yellow-500/30">
                    <p className="text-xs sm:text-sm lg:text-base xl:text-lg font-medium text-gray-800 dark:text-white font-[Georgia,'Times_New_Roman',Times,serif] text-center leading-relaxed">
                      ...
                      , our flavors travel far. Authentic Himalayan cuisine,
                      warm hospitality, and a place to feel at home.
                    </p>
                ...
                <div
                  className={`hidden lg:flex w-full lg:w-1/3 flex-col items-center justify-center order-3 transition-all duration-1000 ease-out ${
                    isVisible
                      ? "translate-x-0 opacity-100"
                      : "translate-x-full opacity-0"
                  }`}
