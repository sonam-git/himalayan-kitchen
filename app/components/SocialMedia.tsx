    ...
    <section className="relative py-20 sm:py-24 lg:py-28 bg-gray-50 dark:bg-gray-400 transition-colors duration-300 overflow-hidden w-full rounded-2xl sm:rounded-3xl shadow-sm border-2 border-gray-200 dark:border-gray-700 p-6 sm:p-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-transparent bg-linear-to-r from-blue-600 via-pink-500 to-orange-500 bg-clip-text mb-4">Follow Us On Social Media</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Facebook Feed Embed */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-blue-200 dark:border-blue-700">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-pink-200 dark:border-pink-700">
            <h3 className="text-2xl font-bold text-pink-500 dark:text-pink-400 mb-4 flex items-center justify-center">
