    ...
    >
      ...
      <div className="mt-8 mb-8">
        <div className="flex items-center justify-between mb-6 px-2">
          <h2 className="text-2xl md:text-3xl font-serif font-bold text-orange-700">Featured Dishes</h2>
          <button
            onClick={() => window.open('https://order.toasttab.com/online/himalayan-kitchen-227-3rd-st', '_blank', 'noopener,noreferrer')}
            className="bg-orange-600 hover:bg-orange-800 text-white font-bold py-2 px-5 rounded-md shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-orange-400 border-2 border-transparent hover:border-white cursor-pointer"
          >
            Full Menu
          </button>
        </div>
        ...
        <div className="flex justify-center mt-4 mb-2">
          <span className="text-base md:text-lg italic text-orange-500">
            &lt;---- scroll to see more ----&gt;
          </span>
        </div>
      </div>
         <div className="w-full bg-linear-to-r from-orange-100 via-yellow-50 to-red-100 dark:bg-linear-to-r dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 dark:shadow-orange-900/30 backdrop-blur-md border-0 rounded-3xl py-12 px-4 md:px-16 my-10 shadow-2xl flex flex-col items-center">
            <h3 className="text-4xl md:text-5xl font-serif font-extrabold mb-6 text-orange-700 dark:text-yellow-200 text-center drop-shadow-lg dark:drop-shadow-xl">
              Experience the Authentic Taste of the Himalayas
            </h3>
            <p className="text-xl md:text-2xl text-gray-800 dark:text-gray-200 mb-10 max-w-2xl text-center">
