    ...
    <div className="group bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border-2 border-gray-100 dark:border-gray-700 hover:border-orange-400 dark:hover:border-orange-500 hover:-translate-y-2 flex flex-col h-full">
      ...
      <div className="p-5 sm:p-6 lg:p-7 flex flex-col ">
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          ...
          <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full shadow-lg flex-shrink-0 flex items-center gap-1">
            {/* Food icon: fork, spoon, and plate SVG */}
            <svg fill="#fff" viewBox="0 -24.48 122.88 122.88" version="1.1" xmlns="http://www.w3.org/2000/svg"  width="22" height="22">
              <g>
