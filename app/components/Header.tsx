          ...
          <div className="flex items-center justify-between h-20 md:h-24">
                ...
                {[
                  ...
                  >
                    ...
                    <span className="relative text-sm xl:text-base font-medium tracking-wide">
                      {label}
                      <span className={`block mt-1 h-0.5 bg-gradient-to-r from-red-500 to-orange-500 rounded-full transition-all duration-300 ${
            ...
            <div className="flex items-center gap-3 md:gap-4 lg:gap-5 xl:gap-6 shrink-0">
              ...
              <button 
                ...
                className="lg:hidden relative inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gray-100 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700/60 shadow-lg transition-all duration-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-400/50"
              >
