              ...
              <div className="flex items-center shrink-0 py-2">
                <div className="flex items-center space-x-3 md:space-x-4 lg:space-x-6 group cursor-pointer">
                  ...
                  <div className="flex flex-col justify-center space-y-0.5 pb-1 notranslate">
                    ...
                    <span className="block pb-1 text-lg md:text-xl lg:text-2xl xl:text-3xl font-script text-gray-700 dark:text-white -mt-1.5 tracking-[0.20em] md:tracking-[0.21em] lg:tracking-[0.22em] xl:tracking-[0.26em] font-bold group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-500">Kitchen Marin</span>
                    <div className="relative">
                      <span className="block text-lg md:text-xl lg:text-2xl xl:text-3xl font-medium text-gray-600 dark:text-gray-300 -mt-1 tracking-[0.01em] md:tracking-[0.012em] lg:tracking-[0.015em] xl:tracking-[0.018em] opacity-90 group-hover:opacity-100 group-hover:text-red-500 dark:group-hover:text-red-400 transition-all duration-500">ཧི་མ་ལ་ཡོན་གྱི་ཟས་ཁང་ མ་རིན།</span>
              ...
              <nav className="hidden xl:flex items-center justify-center flex-1 px-4 xl:px-8 py-2" aria-label="Primary Navigation">
                <div className="flex items-center gap-6 xl:gap-8 2xl:gap-10 py-1">
                  {[
                    ...
                    { id: 'contact', label: 'Contact', href: '/contact-us', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /> }
                          ...
                          {isMenuDropdownOpen && (
                            <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-44 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50 flex flex-col animate-dropdown">
                              <a
                                ...
                                className="px-4 py-3 text-base font-semibold text-gray-800 dark:text-white hover:no-underline hover:bg-yellow-600 hover:text-white dark:hover:bg-yellow-800 rounded-t-xl focus:outline-none focus:bg-red-100 dark:focus:bg-red-700 transition-colors duration-200"
                                tabIndex={0}
