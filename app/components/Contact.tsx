...
const Contact = () => {
  ...
  return (
    <>
      <section id="contact" className="relative bg-white dark:bg-gray-800 transition-colors duration-300 overflow-hidden w-full rounded-2xl sm:rounded-3xl shadow-sm">
